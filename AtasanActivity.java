...
public class AtasanActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
...
//                    Toast.makeText(this, "Could not get location", Toast.LENGTH_SHORT).show();
    ...
    public void signOut() {
        ...
        mAuth.signOut();
        startActivity(new Intent(AtasanActivity.this, LoginPhotoActivity.class));
        finish();
            ...
            protected void onBindViewHolder(@NonNull ListOnlineViewHolder viewHolder, int position, @NonNull final User model) {
                ...
                viewHolder.itemClickListener = new ItemClickListener() {
                    ...
                    public void onClick(View view, int position) {
                        ...
                        Intent map = new Intent(AtasanActivity.this,MapTracking.class);

                        switch (view.getId()) {
                            case R.id.cardView : map = new Intent(AtasanActivity.this,MapTracking.class);
                                if(!model.getEmail().equals(FirebaseAuth.getInstance().getCurrentUser().getEmail())) {
