...
public class ManageAtasanActivity extends AppCompatActivity implements ManageAtasanAdapter.IOnItemClickListener {
    //Deklarasi Variable untuk RecyclerView
    private RecyclerView recyclerView;
    //    private RecyclerView.Adapter adapter;
    private ManageAtasanAdapter ManageAtasanAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Manage Akun Atasan");
    ...
    private void GetData() {
        ...
        dataRef = FirebaseDatabase.getInstance().getReference();
        dataRef.child("Pre-User").child("Atasan")
...
//                          if you not detach the listener, use / learn recommended pattern
               ...
               */
                        ...
                        Log.e("ManageAtasanActivity", databaseError.getDetails() + " " + databaseError.getMessage());
                    }
                });
    }
    ...
    private void MyRecyclerView() {
        ...
        ManageAtasanAdapter = new ManageAtasanAdapter(ManageAtasanActivity.this);
    ...
    public void signOut() {
        ...
        startActivity(new Intent(ManageAtasanActivity.this, LoginPhotoActivity.class));
        finish();
    }

    public void manageAtasan() {
        a = new Intent(this, ManageAtasanActivity.class);
        startActivity(a);
    }
    ...
    public void onItemManageAtasanClickListener(boolean activate, User user) {
        DatabaseReference refAdd = dataRef.child("User").child("Atasan").child(user.getId());
        DatabaseReference refDel = dataRef.child("Pre-User").child("Atasan").child(user.getId());
        if (activate) {
