...
public class ManageSalesActivity extends AppCompatActivity implements com.gawe.tpkom.manageatasan.ManageAtasanAdapter.IOnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Manage Akun Sales");
    ...
    private void GetData() {
        ...
        dataRef = FirebaseDatabase.getInstance().getReference();
        dataRef.child("Pre-User").child("Sales")
...
//                          if you not detach the listener, use / learn recommended pattern
    ...
    private void MyRecyclerView() {
        ...
        ManageAtasanAdapter = new ManageAtasanAdapter(ManageSalesActivity.this);
    ...
    public void signOut() {
        ...
        startActivity(new Intent(ManageSalesActivity.this, LoginPhotoActivity.class));
        finish();
    }
    ...
    public void onItemManageAtasanClickListener(boolean activate, User user) {
        DatabaseReference refAdd = dataRef.child("User").child("Sales").child(user.getId());
        DatabaseReference refDel = dataRef.child("Pre-User").child("Sales").child(user.getId());
        if (activate) {
